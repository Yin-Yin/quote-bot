  ...
  */
  ...
  getSimpleResponse: function(text) {
    return {
      "speech": text,
      "displayText": text,
      "messages": [this.getResponseMessageObject(text), this.getQuickRepliesObject("More?", ["Quote", "Chuck Norris Fact", "Programming Quote", "Trump Quote", "Cat Fact", "Dog Fact", "Random number fact", "Random year fact", "yes or no?"])]
    }
  },
